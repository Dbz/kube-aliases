...
# Manage deployments.
alias kcd="kubectl create deployments"
alias kdeld="kubectl delete deployments"
alias kdd="kubectl describe deployments"
alias kgd="kubectl get deployments"
alias kgdg="kubectl get deployments -o wide | grep"
alias kgad="kubectl get --all-namespaces -o wide deployments"
alias kgadg="kubectl get --all-namespaces -o wide deployments | grep"
alias kgdn="kubectl get deployments -o go-template --template '{{range .items}}{{.metadata.name}}{{\" \"}}{{end}}'"
alias wkgd="watch kubectl get deployments"
alias wkgad="watch kubectl get --all-namespaces -o wide deployments"
alias kgyd="kubectl get -o yaml deployments"
